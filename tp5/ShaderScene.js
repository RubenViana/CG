...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders[6].setUniformsValues({ timeFactor: 0, scaleFactor: this.scaleFactor });
	...
	update(t) {
		...
		if (this.selectedExampleShader == 6)
			...
			this.testShaders[6].setUniformsValues({ timeFactor: t / 100 % 100, scaleFactor: this.scaleFactor });
