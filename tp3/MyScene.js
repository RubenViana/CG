...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Burlywood (low specular)
        this.burlywood = new CGFappearance(this);
        var color = this.hexToRgbA('#deb887');
        this.burlywood.setAmbient(color[0], color[1], color[2], 1.0);
        this.burlywood.setDiffuse(color[0]*0.5, color[1]*0.5, color[2]*0.5, 1.0);
        this.burlywood.setSpecular(0.1, 0.1, 0.1, 1.0);
        this.burlywood.setShininess(10.0);
        ...
        this.materials = [this.material1, this.material2, this.material3, this.customMaterial, this.burlywood];

        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Custom': 3, 'Burlywood': 4 };
    }
    display() {
        ...
        this.setGlobalAmbientLight(this.scaleAmbientLight, this.scaleAmbientLight, this.scaleAmbientLight, 1);
    }
}